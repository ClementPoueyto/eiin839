...
namespace TD3
{
    public class Station
    {
        ...
        public Station(int number, string contract_name, string name, string address, Position position, bool banking, bool bonus, string status, bool connected, bool overflow, string shape, Stand overflowStands, Stand totalStands, Stand mainStands) : this(number, contract_name, name, address, position, banking, bonus)
        {
            this.status = status;
